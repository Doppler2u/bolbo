...
async function fetchUrl(path, method = 'GET', body = null, headers = {}) {
    // We use dynamic import for node-fetch to support ESM in commonjs script
...
async function runTests() {
    ...
    console.log("[1/6] GET /challenge/current");
    ...
    console.log("[5/6] POST /mining/reveal (TESTING FAILURE WITHOUT x402 PAYMENT)");
    ...
    console.log("[6/6] POST /mining/reveal (TESTING SUCCESS)");
    ...
    // 7. Report Invalid
    console.log("[7/6] POST /mining/report-invalid");
